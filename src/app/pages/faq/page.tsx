    ...
    <section id="faq" className="scroll-mt-20">
      <div>
        ...
        <div className="max-w-3xl mx-auto p-4 ">
          <h1 className="text-[20px] font-sans text-center font-normal mb-3 text-[#555555]">
            FREQUENTLY ASKED QUESTION
          </h1>
          <h1 className="text-3xl font-serif text-center mb-[50px]">
            Learn More About <span className="text-[#dd47a3]">SheTech PNC</span>{" "}
            Here
          </h1>
          <div className="space-y-3">
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={index}
                  className="border rounded-[15px]  border-[#D3D3D3] shadow-sm hover:border-pink-400"
                >
                  <button
