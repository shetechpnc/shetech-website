    ...
    <section className="px-6 py-12 max-w-6xl pb-0 mx-auto ">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center ">
        ...
        <div className="space-y-10 pb-0">
          ...
          >
            <div>
              <h4 className="uppercase text-gray-500 font-semibold text-lg mb-4">
                About us
              </h4>
              <h2 className="text-4xl md:text-4xl font-serif mb-4">
                Cultivating{" "}
                <span className="text-[#dd47a3]">Tech Excellence</span> Among
                Women
              </h2>
              <p className="text-gray-700 text-lg font-sans leading-snug mb-[70px] ">
                We are a women-led organization dedicated to empowering and
                advancing women in the field of technology.
              </p>
            </div>
          </motion.div>

          <div className="grid sm:grid-cols-2 font-sans mb-0 relative ">
            <div className="flex flex-col items-start space-y-0 gap-1 p-5 rounded-2xl mr-[50px] transition-shadow ease-in-out hover:shadow-lg cursor-pointer group">
              <motion.div
                whileHover={{
                  y: -6,
              ...
              >
                ...
                <div className="w-full text-left transition-transform group-hover:animate-bounce-once">
                  ...
                  <p className="text-gray-600 text-md leading-snug mb-4 mx-auto  ">
                    To empower and inspire women to become leaders and
                    innovators in the tech industry.
                  </p>
                </div>
              </motion.div>
            </div>
            <div className="flex flex-col items-start space-y-0 gap-1 p-5 rounded-2xl ml-[25px] transition-shadow ease-in-out hover:shadow-lg cursor-pointer">
              <motion.div
                whileHover={{
                  y: -6,
                  transition: { type: "spring", stiffness: 300, damping: 20 },
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-md leading-snug">
                    To support women in tech through education, opportunities,
